...
function configurations.initBoxes()
    ...
    local success, err = pcall(function()
        boxes.background = widgetsAreUs.createBox(10, 50, 750, 400, {0.659, 0.714, 0.8}, 0.8)
        boxes.levelMaintainer = widgetsAreUs.createBox(20, 80, 160, 200, {0.486, 0.631, 0.8}, 1)
        boxes.levelMaintainerConfig = widgetsAreUs.createBox(192, 80, 160, 200, {1, 1, 1}, 1)
        boxes.itemManager = widgetsAreUs.createBox(385, 60, 160, 240, {0.486, 0.631, 0.8}, 1)
        boxes.machineManager = widgetsAreUs.createBox(35, 310, 290, 150, {0.486, 0.631, 0.8}, 1)
