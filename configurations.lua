...
function configurations.initBoxes()
    ...
    local success, err = pcall(function()
        boxes.background = widgetsAreUs.createBox(10, 50, 750, 420, c.background, 0.7)
        boxes.levelMaintainer = widgetsAreUs.createBox(20, 80, 160, 200, c.panel, 0.8)
        boxes.levelMaintainerConfig = widgetsAreUs.createBox(192, 80, 160, 200, c.background2, 0.8)
        boxes.itemManager = widgetsAreUs.createBox(385, 60, 160, 240, c.panel, 0.8)
        boxes.machineManager = widgetsAreUs.createBox(35, 310, 290, 150, c.panel, 0.8)
        boxes.machineManagerConfig = widgetsAreUs.createBox(355, 310, 160, 160, c.background2, 0.8)
        boxes.generalConfig = widgetsAreUs.createBox(520, 310, 200, 160, c.background2, 0.8)
        boxes.itemMangerConfig = widgetsAreUs.createBox(580, 80, 160, 200, c.background2, 0.8)
    end)
    if not success then
